    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative pt-20 pb-32">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-on-scroll opacity-0 translate-y-8 blur-sm">
          ...
          <p className="text-base md:text-lg font-light text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed tracking-wide">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button onClick={() => openChat('book a call')} className="glass-button px-8 py-4 bg-gradient-to-r from-[#0052D4]/20 via-[#4364F7]/20 to-[#6FB1FC]/20 border border-[#4364F7]/30 rounded-lg backdrop-blur-sm font-light tracking-wide hover:from-[#0052D4]/30 hover:via-[#4364F7]/30 hover:to-[#6FB1FC]/30 transition-all duration-300">
              Book A Call
            </button>
            <button onClick={scrollToAbout} className="glass-button px-8 py-4 bg-white/10 border border-white/20 rounded-lg backdrop-blur-sm font-light tracking-wide hover:bg-white/20 transition-all duration-300">
              What is NileByte?
            </button>
          </div>
        </div>
